public class Test {
    public static void main(String[] args) {
        ...
        double[] hybridTest = new double[10];
        for (int i = 0; i < hybridTest.length; i++) {
            hybridTest[i] = Math.random();
        }
       ...
       /* long startTime = System.currentTimeMillis();
        ...
        long startTime = System.currentTimeMillis();
        HybridSort.hybridSort(firstTestArray, 0, firstTestArray.length-1);
        long endTime = System.currentTimeMillis();
        System.out.println("HybridSort 50,000 took " + (endTime - startTime) + " milliseconds");

        long startTime2 = System.currentTimeMillis();
        HybridSort.hybridSort(secondTestArray,0, secondTestArray.length-1);
        long endTime2 = System.currentTimeMillis();
        System.out.println("HybridSort 100,000 took " + (endTime2 - startTime2) + " milliseconds");

        long startTime3 = System.currentTimeMillis();
        HybridSort.hybridSort(thirdTestArray, 0, thirdTestArray.length-1);
        long endTime3 = System.currentTimeMillis();
        System.out.println("HybridSort 150,000 took " + (endTime3- startTime3) + " milliseconds");

        long startTime4 = System.currentTimeMillis();
        HybridSort.hybridSort(fourthTestArray,0, fourthTestArray.length-1);
        long endTime4 = System.currentTimeMillis();
        System.out.println("HybridSort 200,000 took " + (endTime4 - startTime4) + " milliseconds");

        long startTime5 = System.currentTimeMillis();
        HybridSort.hybridSort(fifthTestArray, 0, fifthTestArray.length-1);
        long endTime5 = System.currentTimeMillis();
        System.out.println("HybridSort 250,000 took " + (endTime5 - startTime5) + " milliseconds");

        long startTime6 = System.currentTimeMillis();
        HybridSort.hybridSort(sixthTestArray, 0, sixthTestArray.length-1);
        long endTime6 = System.currentTimeMillis();
        System.out.println("HybridSort 300,000 took " + (endTime6 - startTime6) + " milliseconds");

        long startTime7 = System.currentTimeMillis();
        HybridSort.hybridSort(seventhTestArray, 0 , seventhTestArray.length-1);
        long endTime7 = System.currentTimeMillis();
        System.out.println("HybridSort 350,000 took " + (endTime7- startTime7) + " milliseconds");

        long startTime8 = System.currentTimeMillis();
        HybridSort.hybridSort(eightTestArray, 0, eightTestArray.length-1);
        long endTime8 = System.currentTimeMillis();
        System.out.println("HybridSort 400,000 took " + (endTime8 - startTime8) + " milliseconds");

        long startTime9 = System.currentTimeMillis();
        HybridSort.hybridSort(ninthTestArray,0 , ninthTestArray.length-1);
        long endTime9 = System.currentTimeMillis();
        System.out.println("HybridSort 450,000 took " + (endTime9 - startTime9) + " milliseconds");

        long startTime10 = System.currentTimeMillis();
        HybridSort.hybridSort(tenthTestArray, 0 , tenthTestArray.length-1);
        long endTime10 = System.currentTimeMillis();
        System.out.println("HybridSort 500,000 took " + (endTime10 - startTime10) + " milliseconds");
